...
*/
   ...
   //     inflater.inflate(R.menu.menus, menu);
    ...
    private void initializeUi() {
        ...
        //setContentView(R.layout.activity_checkout);
        //View v = setContentView(R.layout.activity_description);
/*
 ...
 */
    ...
    private void handlePaymentSuccess(PaymentData paymentData) {
        ...
        try {
            ...
            Toast.makeText(this, R.string.payments_show_name, Toast.LENGTH_LONG).show();
    ...
    public void requestPayment(View view) {
        ...
        // This price is not displayed to the user.
            ...
            double garmentPrice = 100; // selectedGarment.getDouble("price");
            long garmentPriceCents = 50; //Math.round(garmentPrice * PaymentsUtil.CENTS_IN_A_UNIT.longValue());
