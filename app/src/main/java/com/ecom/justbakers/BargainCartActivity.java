...
public class BargainCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Firebase BargainCartRef = new Firebase("https://justbakers-285be.firebaseio.com/BargainCarts/");
                ...
                if(BargainProductList.isEmpty()){
                    ...
                    adapter = new CustomBargainCartAdapter(BargainProductList, BargainID, getLayoutInflater(), BargainCartActivity.this, new ButtonClickListener() {
                        ...
                        public void onButtonClick(int position, View v) {
                            Firebase deleteref = new Firebase("https://justbakers-285be.firebaseio.com/BargainCarts/"
                        ...
                        public void onButtonClick(int position,View v) {
                            ...
                            Firebase deleteref = new Firebase("https://justbakers-285be.firebaseio.com/BargainCarts/" + BargainID.get(position));
                            deleteref.removeValue();
