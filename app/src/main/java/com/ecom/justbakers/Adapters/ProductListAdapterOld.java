...
public class ProductListAdapterOld extends BaseAdapter {
    ...
    public ProductListAdapterOld(@NotNull Activity cxt, @NotNull ArrayList<Product> products, @NotNull Map<String, Product> cartProducts, Consumer<Pair<Action, Product>> cartChangedConsumer) {
        context = cxt;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(null == viewHolder) {
            ...
            viewHolder.discountedPrice = convertView.findViewById(R.id.discount_price);
            viewHolder.discountTextView = convertView.findViewById(R.id.discount_text_view);
            viewHolder.productImage = convertView.findViewById(R.id.product_image_view);
            viewHolder.addedInfo = convertView.findViewById(R.id.added_info);
            viewHolder.addToCart = convertView.findViewById(R.id.add_to_cart);
            viewHolder.bargain = convertView.findViewById(R.id.bargain_button);
            viewHolder.addButton = convertView.findViewById(R.id.add_button);
            viewHolder.subButton = convertView.findViewById(R.id.sub_button);
            viewHolder.quantityButton = convertView.findViewById(R.id.quantity_button);
        }
    ...
    private void cartButtonClick(@Nullable Product product, FButton addToCart, FButton addButton, FButton subButton, FButton quantityButton){
